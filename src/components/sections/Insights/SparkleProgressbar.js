...
const SparkleProgressbar = (props) => {
  ...
  return (
    <div className={classes.sparkleProgressbar} emotion={props.emotion}>
      <div
        className={`${classes.sparkleBar} ${classes[props.color]}`}
        style={sparkleBarStyle}
      >
        <span></span>
      </div>
      <div
        className={classes.sparkleLabel}
